...
class HatchService {
  ...
  static const List<_HatchTemplate> _chart = [
    _HatchTemplate(
      ...
      HatchStage.emerger,
      [3, 4, 5, 9, 10, 11],
      HatchProbability.high,
      ['BWO Emerger #18', 'CDC Dun #18'],
    ),
    _HatchTemplate(
      'March Brown',
      HatchStage.adult,
      [3, 4, 5],
      HatchProbability.medium,
      ['March Brown Dun #12', 'Pheasant Tail #14'],
    ),
    _HatchTemplate(
      'Grannom Caddis',
      HatchStage.adult,
      [4, 5],
      HatchProbability.high,
      ['Elk Hair Caddis #14', 'Grannom Pupa #14'],
    ),
    _HatchTemplate(
      'Sulphur',
      HatchStage.emerger,
      [5, 6, 7],
      HatchProbability.high,
      ['Sulphur Comparadun #16', 'PT Emerger #16'],
    ),
    _HatchTemplate(
      'Green Drake (Mayfly)',
      HatchStage.adult,
      [5, 6],
      HatchProbability.medium,
      ['Green Drake #10', 'Mayfly Spinner #10'],
    ),
    _HatchTemplate(
      'Caddis',
      HatchStage.larva,
      [5, 6, 7, 8],
      HatchProbability.high,
      ['Elk Hair Caddis #14', 'Caddis Larva #14'],
    ),
    _HatchTemplate(
      'Pale Morning Dun',
      HatchStage.adult,
    ...
    _HatchTemplate(
      ...
      [1, 2, 3, 11, 12],
      HatchProbability.medium,
      ['Zebra Midge #20', 'Griffiths Gnat #20'],
    ),
  ];
